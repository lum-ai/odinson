...
class TestDocumentationWalkthrough extends OdinsonTest{
  ...
  it should "find the adoption event" in {
    ...
    testMention(adoptions.head, "adopted", Seq(Argument("adopter", "Sally"), Argument("pet", "cat")), extractorEngine)
  }
