...
class ExtractorEngine private( val index : OdinsonIndex,
    ...
    private def odinSearch( after : OdinsonScoreDoc,
        ...
        require( after == null || after.doc < limit, s"after.doc exceeds the number of documents in the reader: after.doc=${after.doc} limit=${limit}" )
    ...
    def extractNoState(
      ...
      disableMatchSelector : Boolean ) : Iterator[ Mention ] = {
